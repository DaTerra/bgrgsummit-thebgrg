...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SitewebBackBundle:Contact')->findAll();

        return $this->render('SitewebBackBundle:Contact:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SitewebBackBundle:Contact')->find($id);
        ...
        return $this->render('SitewebBackBundle:Contact:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SitewebBackBundle:Contact:edit.html.twig', array(
            'entity'      => $entity,
