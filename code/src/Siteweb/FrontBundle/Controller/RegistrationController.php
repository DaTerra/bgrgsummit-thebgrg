...
class RegistrationController extends ContainerAware
{
    public function registerAction(Request $request)
    {
        ...
        if ($process) {
            ...
            $umtid = $request->get('membership-type');
            $em = $this->container->get('doctrine')->getManager();
            $usermembershiptype = $em->getRepository('SitewebBackBundle:Usermembershiptype')->findOneById(intval($umtid));
            $usermembership = new Usermembership();
            $usermembership->setCreated(new \DateTime('H:m:d H:i:s'));
    ...
    public function confirmAction($token)
    {
        ...
        $user->setLastLogin(new \DateTime('H:m:d H:i:s'));
