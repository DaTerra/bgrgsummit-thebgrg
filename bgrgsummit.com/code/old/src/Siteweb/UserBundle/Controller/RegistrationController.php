...
class RegistrationController extends ContainerAware
{
    public function registerAction()
    {
        ...
        if ($process) {
            ...
            $usermembershiptype = $em->getRepository('SitewebBackBundle:Usermembershiptype')->findOneByTitle('SUMMIT2015_Attendees');
            $usermembership = new Usermembership();
            $usermembership->setCreated(new \DateTime());
            $usermembership->setUser($user);
            $usermembership->setPublic($user->getPublicprofile());
