...
use Siteweb\BackBundle\Entity\Scolarshiprequests;
use Siteweb\BackBundle\Form\DemographicType;
use Siteweb\BackBundle\Form\ScolarshiprequestsType;
use Symfony\Component\Form\AbstractType;
use Symfony\Component\Form\FormBuilderInterface;
use Symfony\Component\OptionsResolver\OptionsResolverInterface;

class UserscolarshipType extends AbstractType
{
        /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('scolarshiprequest',new ScolarshiprequestsType())
    ...
    {
        return 'siteweb_scolarshipuser_registration';
    }
}
