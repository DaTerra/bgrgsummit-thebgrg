...
class User extends BaseUser
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Siteweb\BackBundle\Entity\Scolarshiprequests", mappedBy="user",cascade={"all"})
     */
    private $scolarshiprequest;

    /**
     * @ORM\OneToOne(targetEntity="Siteweb\BackBundle\Entity\Awardnominee", mappedBy="submitter",cascade={"all"})
     */
     ...
     * @return User
     */
    public function setScolarshiprequest(\Siteweb\BackBundle\Entity\Scolarshiprequests $scolarshiprequest)
    {
        $this->scolarshiprequest = $scolarshiprequest;
        $scolarshiprequest->setUser($this);
