...
class RenewPaymentController  extends PayumController
{
    public function prepareRenewPaymentAction()
    {
        ...
        $paymentDetails['PAYMENTREQUEST_0_AMT'] = ''.$usermembership->getUsermembership()->getPrice();
        $paymentDetails['L_PAYMENTREQUEST_0_AMT0'] = ''.$usermembership->getUsermembership()->getPrice();
